...
public class CostumeExtenderTest {
  ...
  @Test
  public void canRetrieveCostumeThreeExtensions() throws Exception {
    SeqEdit c3p1_1 = new SeqEdit(C3P1_1V1_NAME, C3P1_1V1_OFFSET, 0, C3P1_1V1_BYTES, C3P1_1V1_BYTES);
    SeqEdit c4p1_1 = new SeqEdit(C4P1_1V1_NAME, C4P1_1V1_OFFSET, 0, C4P1_1V1_BYTES, C4P1_1V1_BYTES);
    SeqEdit c3p2_1 = new SeqEdit(C3P2_1V1_NAME, C3P2_1V1_OFFSET, 0, C3P2_1V1_BYTES, C3P2_1V1_BYTES);
    SeqEdit c4p2_1 = new SeqEdit(C4P2_1V1_NAME, C4P2_1V1_OFFSET, 0, C4P2_1V1_BYTES, C4P2_1V1_BYTES);
    List<SeqEdit> list_1v1 = List.of(c3p1_1, c3p2_1, c4p1_1, c4p2_1);

    List<String> expected = List.of(SAKURA, HAKU, INO);
    assertThat(CostumeExtender.getCostumeThreeCharacters(list_1v1)).isEqualTo(expected);

    String extendAllChrs = """
        ...
        """;
    byte[] bytes = ByteUtils.hexTextToBytes(extendAllChrs);
    c3p1_1 = new SeqEdit(C3P1_1V1_NAME, C3P1_1V1_OFFSET, 0, C3P1_1V1_BYTES, bytes);
    list_1v1 = List.of(c3p1_1, c3p2_1, c4p1_1, c4p2_1);
    List<String> allCharacters = INTERNAL_CHAR_ORDER.entrySet()
        .stream()
        .sorted(Entry.comparingByValue())
        .map(Entry::getKey)
        .collect(Collectors.toList());
    assertThat(CostumeExtender.getCostumeThreeCharacters(list_1v1)).isEqualTo(allCharacters);
  }

  @Test
  public void canRetrieveCostumeFourExtensions() throws Exception {
    SeqEdit c3p1_1 = new SeqEdit(C3P1_1V1_NAME, C3P1_1V1_OFFSET, 0, C3P1_1V1_BYTES, C3P1_1V1_BYTES);
    SeqEdit c4p1_1 = new SeqEdit(C4P1_1V1_NAME, C4P1_1V1_OFFSET, 0, C4P1_1V1_BYTES, C4P1_1V1_BYTES);
    SeqEdit c3p2_1 = new SeqEdit(C3P2_1V1_NAME, C3P2_1V1_OFFSET, 0, C3P2_1V1_BYTES, C3P2_1V1_BYTES);
    SeqEdit c4p2_1 = new SeqEdit(C4P2_1V1_NAME, C4P2_1V1_OFFSET, 0, C4P2_1V1_BYTES, C4P2_1V1_BYTES);
    ...
    String extendAllChrs = """
        ...
        """;
    byte[] bytes = ByteUtils.hexTextToBytes(extendAllChrs);
    c4p1_1 = new SeqEdit(C4P1_1V1_NAME, C4P1_1V1_OFFSET, 0, C4P1_1V1_BYTES, bytes);
    list_1v1 = List.of(c3p1_1, c3p2_1, c4p1_1, c4p2_1);
    List<String> allCharacters = INTERNAL_CHAR_ORDER.entrySet()
        .stream()
        .sorted(Entry.comparingByValue())
        .map(Entry::getKey)
        .collect(Collectors.toList());
    assertThat(CostumeExtender.getCostumeFourCharacters(list_1v1)).isEqualTo(allCharacters);
  }
