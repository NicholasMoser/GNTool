...
/**
 * Reads the CRC32 base hash values from the associated resources file. This class can be used to compare to a new set of hash values to see which files have been modified.
 */
public class CRC32BaseValues
{
    ...
    public CRC32BaseValues()
    {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("crc32.csv"), StandardCharsets.UTF_8)))
        {
            String line;
