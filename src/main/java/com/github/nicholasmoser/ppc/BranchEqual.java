...
public class BranchEqual {
  /**
   * Gets the branch if equal instruction bytes for moving from one address to another address.
   *
   * @param from The from address.
   * @param to   The to address.
   * @return The branch if equal instruction bytes.
   */
  ...
  /**
   * Gets the branch if equal instruction bytes for moving the given distance of instructions.
   *
