...
public class DolPatcher
{
    ...
    /**
     * Patches the audio fix into the dol file. This will replace the instruction bytes at 0x8016fc08 from 0x41820020 to 0x48000021. Or in plain terms, changes the conditional branch to an
