...
public class GNT4Files {
  ...
  /**
   * Retrieves all compressed files in GNT4. Returns an empty array if none are found. It is more
   * efficient to retrieve specific parent/children instead of this method. GNT4 has 119 non-FPK
   * files.
   * 
  ...
  /**
   * Retrieves the id of a given file (specifically fpk child). These are the String identifiers
   * used in the fpk itself.
   * 
  ...
  /**
   * Whether or not the child file is normally compressed. This should only be called on fpk
   * children.
   * 
