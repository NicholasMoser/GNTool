...
public class GNT4Stages {
  ...
  public static final String KONOHA_HOT_SPRINTS = "Hot Springs";
  public static final String SUNAGAKURE = "Hidden Sand Village";
  public static final String DEEP_FOREST_EMERGENCY = "Deep Forest Emergence Rooftop";
  public static final String TANZAKU_CASTLE = "Tanzaku Castle";
  public static final String NINE_TAILED_FOX_ROOM = "Kyuubi Chamber";
  public static final String THREE_WAY_DEADLOCK = "Three-Way Deadlock";
  public static final String AMID_TOADS_1 = "Gamabunta's Bath";
  ...
  public static final String KONOHA_GATE_DAY = "Konoha Gates - Day";
  public static final String ACADEMY_SCHOOLYARD_SUNSET = "Academy Yard - Sunrise";
  public static final String FOREST_OF_DEATH_NIGHT = "Forest of Death - Night";
  public static final String GREAT_NARUTO_BRIDGE_CLEAR = "Great Naruto Bridge";
  public static final String GREAT_NARUTO_BRIDGE_FOG = "Great Naruto Bridge - Mist";
  public static final String AMID_TOADS_2 = "Gamabunta's Bath - 2";
  public static final String ACADEMY_ROOFTOP_NIGHT = "Academy Rooftop - Storm";
  public static final String ICHIRAKU_RAMEN_SUNSET = "Ichiraku Ramen - Sunset";
  public static final String KONOHA_GATE_NIGHT = "Konoha Gates - Night";
  public static final String ACADEMY_SCHOOLYARD_DAY = "Academy Yard - Day";
  public static final String FOREST_OF_DEATH_MORNING = "Forest of Death - Morning";
  public static final String CHUNIN_EXAMS_QUALIFIERS = "Chuunin Exam Preliminaries";
  public static final String CHUNIN_EXAMS_FINALS = "Chuunin Exam Finals";
  public static final String CHUNIN_EXAMS_ROOFTOP = "Chunin Exams Rooftop - Sound 4 Barrier";
  public static final String KONOHA_HOSPITAL_ROOFTOPS = "Konoha Hospital";
  ...
  public static final String ABANDONED_UCHIHA_DISTRICT = "Uchiha Compound";
  public static final String SNOW_VALLEY = "Land of Ice";
  public static final String OROCHIMARUS_LAID = "Orochimaru's Lair";
  public static final String SHAMBLED_PLAINS = "Plains";
