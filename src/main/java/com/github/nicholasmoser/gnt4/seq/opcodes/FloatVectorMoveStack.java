...
public class FloatVectorMoveStack implements Opcode {

  private final static String MNEMONIC = "fvec_movs";
  private final int offset;
  private final byte[] bytes;
  private final String info;

  public FloatVectorMoveStack(int offset, byte[] bytes, String info) {
    this.offset = offset;
    this.bytes = bytes;
    this.info = info;
  }
