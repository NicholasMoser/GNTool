...
public class OpcodeGroup41 {
  ...
  public static Opcode parse(ByteStream bs, byte opcodeByte) throws IOException {
    return switch (opcodeByte) {
      ...
      case 0x08 -> UnknownOpcode.of(0x41, 0x08, 0x4, bs);
      case 0x09 -> UnknownOpcode.of(0x41, 0x09, 0x4, bs);
      case 0x0A -> UnknownOpcode.of(0x41, 0x0A, 0x8, bs);
      case 0x0B -> UnknownOpcode.of(0x41, 0x0B, 0x8, bs);
      case 0x0C -> UnknownOpcode.of(0x41, 0x0C, 0x4, bs);
      case 0x0D -> UnknownOpcode.of(0x41, 0x0D, 0x10, bs);
      case 0x0E -> UnknownOpcode.of(0x41, 0x0E, 0x8, bs);
