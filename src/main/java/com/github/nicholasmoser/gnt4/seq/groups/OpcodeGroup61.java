...
public class OpcodeGroup61 {
  public static Opcode parse(ByteStream bs, byte opcodeByte) throws IOException {
    return switch (opcodeByte) {
      ...
      case 0x2C -> UnknownOpcode.of(0x61, 0x2C, 0x8, bs);
      case 0x32 -> UnknownOpcode.of(0x61, 0x32, 0x8, bs);
      case 0x33 -> UnknownOpcode.of(0x61, 0x33, 0x8, bs);
      case 0x34 -> UnknownOpcode.of(0x61, 0x34, 0x8, bs);
      case 0x3C -> UnknownOpcode.of(0x61, 0x3C, 0xC, bs);
      case 0x3D -> UnknownOpcode.of(0x61, 0x3D, 0x10, bs);
      case 0x48 -> UnknownOpcode.of(0x61, 0x48, 0x8, bs);
      case 0x49 -> UnknownOpcode.of(0x61, 0x49, 0x8, bs);
      case 0x4C -> UnknownOpcode.of(0x61, 0x4C, 0x8, bs);
      ...
      case 0x63 -> UnknownOpcode.of(0x61, 0x63, 0xc, bs);
      ...
      case (byte) 0x9F -> UnknownOpcode.of(0x61, 0x9F, 0x8, bs);
      ...
      case (byte) 0xF5 -> UnknownOpcode.of(0x61, 0xF5, 0x4, bs);
