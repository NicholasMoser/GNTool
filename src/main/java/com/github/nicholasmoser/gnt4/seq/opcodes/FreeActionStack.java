...
public class FreeActionStack implements Opcode {

  private final static String MNEMONIC = "free_action_stack";
  private final int offset;
  private final byte[] bytes;
  private final String info;

  public FreeActionStack(int offset, byte[] bytes, String info) {
    this.offset = offset;
    this.bytes = bytes;
    this.info = info;
  }
