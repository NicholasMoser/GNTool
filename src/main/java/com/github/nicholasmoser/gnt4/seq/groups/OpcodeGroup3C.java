...
public class OpcodeGroup3C {
  public static Opcode parse(ByteStream bs, byte opcodeByte) throws IOException {
    return switch (opcodeByte) {
      ...
      case 0x06 -> UnknownOpcode.of(0x3C, 0x06, 0xc, bs);
      case 0x07 -> UnknownOpcode.of(0x3C, 0x07, 0xc, bs);
      ...
      case 0x12 -> UnknownOpcode.of(0x3C, 0x12, 0x10, bs);
      ...
      case 0x18 -> UnknownOpcode.of(0x3C, 0x18, 0x14, bs);
