...
public class OpcodeGroup47 {
  public static Opcode parse(ByteStream bs, byte opcodeByte) throws IOException {
    return switch (opcodeByte) {
      ...
      case 0x09 -> UnknownOpcode.of(0x47, 0x09, 0xC, bs);
      ...
      case 0x10 -> UnknownOpcode.of(0x47, 0x10, 0x10, bs);
      case 0x11 -> UnknownOpcode.of(0x47, 0x11, 0x14, bs);
      case 0x12 -> op_4712(bs);
      case 0x13 -> UnknownOpcode.of(0x47, 0x13, 0x8, bs);
