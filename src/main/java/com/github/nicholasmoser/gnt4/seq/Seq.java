...
public class Seq {
    ...
    public static final String PROGRESS_THROUGH_FRAMES_UNTIL_END_DESCRIPTION = "Single command, no value";
    ...
    public static final String HORIZ_MOBILITY_JUMP_MOVES_DESCRIPTION = "Horizontal Mobility for Jump Moves";

    public static final int VERT_MOBILITY_JUMP_MOVES_ID = 0x2414020B;
    public static final String VERT_MOBILITY_JUMP_MOVES_DESCRIPTION = "Vertical Mobility for Jump Moves";

    public static final int PROJ_DMG_STUN_GUARD_ID = 0x47040000;
    public static final String PROJ_DMG_STUN_GUARD_DESCRIPTION = "Projectile damage, stun, guard damage, etc";
    ...
    public static final Map<Integer, String> KF_ATTACK_FLAGS = Map.ofEntries(
            new AbstractMap.SimpleEntry<Integer, String>(0x00000001, "replay"),      // No effect
            new AbstractMap.SimpleEntry<Integer, String>(0x00000002, "BDrive"),      // Changes lighting, no sub or tech roll, generally on Ougi moves
            new AbstractMap.SimpleEntry<Integer, String>(0x00000004, "Shot"),
            new AbstractMap.SimpleEntry<Integer, String>(0x00000008, "Pow_W"),       // Weak hit. affects blockstun and hitstun
            ...
            new AbstractMap.SimpleEntry<Integer, String>(0x00000040, "Low"),         // Attack hits low, and can be evaded by AF float flag
            new AbstractMap.SimpleEntry<Integer, String>(0x00000080, "Middle"),      // Attack hits middle
            new AbstractMap.SimpleEntry<Integer, String>(0x00000100, "High"),        // Attack hits high, and can be evaded by AF sit flag
            new AbstractMap.SimpleEntry<Integer, String>(0x00000200, "Punch"),       // Attack is classified as a punch
            new AbstractMap.SimpleEntry<Integer, String>(0x00000400, "Kick"),        // Attack is classified as a kick
            new AbstractMap.SimpleEntry<Integer, String>(0x00000800, "Throw"),       // Attack is classified as a throw, no sub or tech roll
            new AbstractMap.SimpleEntry<Integer, String>(0x00001000, "Oiuchi"),      // Hits later on OTG and during tech rolls (also called “Pursuit”)
            new AbstractMap.SimpleEntry<Integer, String>(0x00002000, "Special"),     // Builds no chakra, generally seen on Ougi moves
            ...
            new AbstractMap.SimpleEntry<Integer, String>(0x00010000, "SPTata"),      // This is a large bounce. Ex: Naruto 4B
            new AbstractMap.SimpleEntry<Integer, String>(0x00020000, "Break"),       // This combines with other KF flags to affect the opponents guard.
            new AbstractMap.SimpleEntry<Integer, String>(0x00040000, "Combo"),       // Still not entirely understood
            new AbstractMap.SimpleEntry<Integer, String>(0x00080000, "Down"),        // Spinout launcher. Launches higher than Uki flag
            new AbstractMap.SimpleEntry<Integer, String>(0x00100000, "Yoro"),        // Stagger
            new AbstractMap.SimpleEntry<Integer, String>(0x00200000, "Butt"),        // Flying Screen knockback
            new AbstractMap.SimpleEntry<Integer, String>(0x00400000, "Uki"),         // Launch on hit
            new AbstractMap.SimpleEntry<Integer, String>(0x00800000, "Furi"),        // Turns opponents around on hit. This is leftover from Bloody Roar and not used.
            new AbstractMap.SimpleEntry<Integer, String>(0x01000000, "Koro"),        // Sweep: beats super armor, cannot be Y cancelled
            new AbstractMap.SimpleEntry<Integer, String>(0x02000000, "Reach_L"),     // Unsure, but generally in attacks with a good deal of motion. Ex: Naruto 6B
            new AbstractMap.SimpleEntry<Integer, String>(0x04000000, "Tata"),        // Small Ground Bounce. Ex: Naruto 6B
            new AbstractMap.SimpleEntry<Integer, String>(0x08000000, "NoSpeEp"),
            new AbstractMap.SimpleEntry<Integer, String>(0x10000000, "Beast"),       // Slash hit effect and chip damage
            new AbstractMap.SimpleEntry<Integer, String>(0x20000000, "Freeze"),      // Opponent moves less during the attack, which allows moves to combo better
            new AbstractMap.SimpleEntry<Integer, String>(0x40000000, "Cancel"),      // Cancel the move when you press Y like an any frame feint (not used)
    ...
    public static final String K2F_SPECIAL_ATTACK_PROJ_FLAG_DESCRIPTION = "K2F Special Attack Flags (Projectile)";
    public static final Map<Integer, String> K2F_SPECIAL_ATTACK_FLAGS = Map.ofEntries(
        new AbstractMap.SimpleEntry<Integer, String>(0x00000001, "yoro2"),       // Feet trapped. Ex: Kidomaru 5A1C
            new AbstractMap.SimpleEntry<Integer, String>(0x00000002, "hiki"),        // Sink into the ground and pop out. Ex: Jiraya 2A
            new AbstractMap.SimpleEntry<Integer, String>(0x00000004, "hiki2"),       // Sink into the ground and fall from above. Ex: Shika 2X
            ...
            new AbstractMap.SimpleEntry<Integer, String>(0x00000020, "superarmor"),  // Gives the move super armor, must be turned off. Ex: Chouji 5A
            new AbstractMap.SimpleEntry<Integer, String>(0x00000040, "mato2"),       // Trapped. Ex: Shino 2A
            new AbstractMap.SimpleEntry<Integer, String>(0x00000080, "atkallcan"),   // Can follow up with any other attack
            new AbstractMap.SimpleEntry<Integer, String>(0x00000100, "toji"),
            new AbstractMap.SimpleEntry<Integer, String>(0x00000200, "hasa"),        // Crumple. Ex: Jirobo stone clap crumple
    ...
    public static final Map<Integer, String> NF_STATE_FLAGS = Map.ofEntries(
        new AbstractMap.SimpleEntry<Integer, String>(0x00000001, "kamae"),
        new AbstractMap.SimpleEntry<Integer, String>(0x00000002, "disp"),        // Disappears, can even walk through opponent while invisible.
        new AbstractMap.SimpleEntry<Integer, String>(0x00000004, "tdmg"),        // Used in conjuction with tdown for intangibility.
        new AbstractMap.SimpleEntry<Integer, String>(0x00000008, "jump2"),       // Flag that appears after doing your midair jump
        ...
        new AbstractMap.SimpleEntry<Integer, String>(0x00000400, "bdrivesleep"), // Makes BDrive not active.
        ...
        new AbstractMap.SimpleEntry<Integer, String>(0x00004000, "shotdef"),     // Expected this to block projectiles. It didn"t.
        ...
        new AbstractMap.SimpleEntry<Integer, String>(0x00080000, "disp_n"),      // Disappears. Ends at the end of the action..?
        new AbstractMap.SimpleEntry<Integer, String>(0x00100000, "kabehit"),
        new AbstractMap.SimpleEntry<Integer, String>(0x00200000, "bodytouch"),   // Used for some throw attacks like Kisame. Disables sub.
        ...
        new AbstractMap.SimpleEntry<Integer, String>(0x02000000, "autodir"),     // Determines if something has any tracking on it..?
    ...
    public static final Map<Integer, String> AF_ACTION_STATE_FLAGS = Map.ofEntries(
        new AbstractMap.SimpleEntry<Integer, String>(0x00000001, "stand"),
        ...
        new AbstractMap.SimpleEntry<Integer, String>(0x00000010, "sit"),         // Immune to high attacks.
        ...
        new AbstractMap.SimpleEntry<Integer, String>(0x02000000, "uki"),         // Note: if this is added on an attacking move, that move can no longer Y cancel.
        new AbstractMap.SimpleEntry<Integer, String>(0x04000000, "butt"),
        new AbstractMap.SimpleEntry<Integer, String>(0x08000000, "ndown"),
        new AbstractMap.SimpleEntry<Integer, String>(0x10000000, "def"),         // Defense from the front. Like 4B guard.
    ...
    public static final Map<Integer, Action> OFFSET_TO_ACTION = Map.ofEntries(
        new AbstractMap.SimpleEntry<Integer, Action>(0x030, new Action(0x000, "Do nothing (Freeze animations)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x050, new Action(0x008, "Freeze character (Can be thrown out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x0C0, new Action(0x024, "Freeze character (Can be thrown out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0C4, new Action(0x025, "Transformation Y-cancel")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0C8, new Action(0x026, "Hit out of air")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0CC, new Action(0x027, "Freeze character (Can be thrown out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0D0, new Action(0x028, "Intro Animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0D4, new Action(0x029, "Disable all your attacks except throw")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0D8, new Action(0x02A, "Win Animation (Disable all your attacks)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0DC, new Action(0x02B, "Win Animation (Including camera,  softlocks)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0E0, new Action(0x02C, "Win Animation (Including camera,  softlock")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0E4, new Action(0x02D, "Missing animation? (softlock)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0E8, new Action(0x02E, "Lose round animation (softlock character)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x0EC, new Action(0x02F, "Intro animation? (Can be thrown out,  only throws will work after)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x114, new Action(0x039, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x118, new Action(0x03A, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x11C, new Action(0x03B, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x120, new Action(0x03C, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x124, new Action(0x03D, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x128, new Action(0x03E, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x12C, new Action(0x03F, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x130, new Action(0x040, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x134, new Action(0x041, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x138, new Action(0x042, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x13C, new Action(0x043, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x140, new Action(0x044, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x144, new Action(0x045, "Getting hit animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x148, new Action(0x046, "Hard knockdown animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x14C, new Action(0x047, "Hard knockdown animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x150, new Action(0x048, "Round loss animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x154, new Action(0x049, "Hard knockdown animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x158, new Action(0x04A, "Hard knockdown animation")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x15C, new Action(0x04B, "Hit with Special (lose all chakra)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x160, new Action(0x04C, "Hit with hiki2 (Sink into the ground and fall from above. Ex, Shika 2X)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x164, new Action(0x04D, "Hit with hiki (Sink into the ground and pop out. Ex, Jiraya 2A)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x168, new Action(0x04E, "Hit with mato2 (Trapped. Ex, Shino 2A)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x16C, new Action(0x04F, "Hit hard")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x170, new Action(0x050, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x174, new Action(0x051, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x178, new Action(0x052, "Hit with yoro2 (Feet trapped. Ex, Kidomaru 5A1C)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x17C, new Action(0x053, "Hit hard")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x180, new Action(0x054, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x184, new Action(0x055, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x188, new Action(0x056, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x18C, new Action(0x057, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x190, new Action(0x058, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x194, new Action(0x059, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x198, new Action(0x05A, "Hit and stuck in ground (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x19C, new Action(0x05B, "Hit and stuck in air (Can be hit out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x1A8, new Action(0x05E, "Hit with Furi (Turns opponents around on hit. Leftover from Bloody Roar; not used.)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x1AC, new Action(0x05F, "Hit with Furi (Turns opponents around on hit. Leftover from Bloody Roar; not used.)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x1B0, new Action(0x060, "Hit and stuck in air (Can be hit out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x218, new Action(0x07A, "Get up roll backwards")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x240, new Action(0x084, "Hard knockdown to the left")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x244, new Action(0x085, "Hard knockdown to the right")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x254, new Action(0x089, "Hard knockdown forward")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x268, new Action(0x08E, "Hard knockdown bounce")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x26C, new Action(0x08F, "Hard knockdown bounce")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x270, new Action(0x090, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x274, new Action(0x091, "Hit and stuck in air (Can be hit out)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x278, new Action(0x092, "Hard knockdown slow bounce")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x27C, new Action(0x093, "Hard knockdown slow bounce")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x32C, new Action(0x0BF, "Stuck in air (Can be hit out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x354, new Action(0x0C9, "Become invisible (revert when hit)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x360, new Action(0x0CC, "Teleport behind opponent")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x428, new Action(0x0FE, "Stuck in air (Can be hit out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x458, new Action(0x10A, "Stuck in air (Can be hit out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x488, new Action(0x116, "Stuck in air (Can be hit out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x4B0, new Action(0x120, "Stuck in air (Can be hit out)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x4C8, new Action(0x126, "Do nothing (head movement?)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x4CC, new Action(0x127, "Do nothing (head movement?)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x4D0, new Action(0x128, "Remove character from game")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x4F0, new Action(0x130, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x4F4, new Action(0x131, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x4F8, new Action(0x132, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x4FC, new Action(0x133, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x500, new Action(0x134, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x504, new Action(0x135, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x508, new Action(0x136, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x50C, new Action(0x137, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x510, new Action(0x138, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x514, new Action(0x139, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x518, new Action(0x13A, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x51C, new Action(0x13B, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x520, new Action(0x13C, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x524, new Action(0x13D, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x528, new Action(0x13E, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x52C, new Action(0x13F, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x530, new Action(0x140, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x534, new Action(0x141, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x538, new Action(0x142, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x53C, new Action(0x143, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x540, new Action(0x144, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x544, new Action(0x145, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x548, new Action(0x146, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x54C, new Action(0x147, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x550, new Action(0x148, "Combo Moves (character-specific)")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x554, new Action(0x149, "Combo Moves (character-specific)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x684, new Action(0x195, "Activated X (Transformation)")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x770, new Action(0x1D0, "Activated 3-Man X #1")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x774, new Action(0x1D1, "Activated 3-Man X #2")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x778, new Action(0x1D2, "Activated 3-Man X #3")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x77C, new Action(0x1D3, "Activated 3-Man X #4")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x780, new Action(0x1D4, "Do nothing")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x784, new Action(0x1D5, "Activated 3-Man X #5")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x7AC, new Action(0x1DF, "Activated 3-Man X #6")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x7B8, new Action(0x1E2, "Thrown on the ground")),
        ...
        new AbstractMap.SimpleEntry<Integer, Action>(0x8BC, new Action(0x223, "Getting hit by super")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x8C0, new Action(0x224, "Do nothing")),
        new AbstractMap.SimpleEntry<Integer, Action>(0x8C4, new Action(0x225, "Getting hit by super")),
