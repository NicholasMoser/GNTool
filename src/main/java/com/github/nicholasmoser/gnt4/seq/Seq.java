...
public class Seq {
  ...
  public static String getActionDescription(int actionId) {
    ...
    return description != null ? description : "Unused";
  }
  ...
  private static Map<Integer, String> initActionDescriptions() {
    ...
    actionDescriptions.put(0x170, "Crash");
    actionDescriptions.put(0x171, "Crash");
    actionDescriptions.put(0x172, "Crash");
    actionDescriptions.put(0x173, "Crash");
    actionDescriptions.put(0x174, "Crash");
    actionDescriptions.put(0x175, "Crash");
    actionDescriptions.put(0x176, "Crash");
    actionDescriptions.put(0x177, "Crash");
    actionDescriptions.put(0x178, "Crash");
    actionDescriptions.put(0x179, "Crash");
    actionDescriptions.put(0x17A, "Crash");
    actionDescriptions.put(0x17B, "Crash");
    actionDescriptions.put(0x17C, "Crash");
    actionDescriptions.put(0x17D, "Crash");
    actionDescriptions.put(0x17E, "Crash");
    actionDescriptions.put(0x17F, "Crash");
    actionDescriptions.put(0x180, "Crash");
    actionDescriptions.put(0x181, "Crash");
    actionDescriptions.put(0x182, "Crash");
    actionDescriptions.put(0x183, "Crash");
    actionDescriptions.put(0x184, "Crash");
    actionDescriptions.put(0x185, "Crash");
    actionDescriptions.put(0x186, "Crash");
    actionDescriptions.put(0x187, "Crash");
    actionDescriptions.put(0x188, "Crash");
    actionDescriptions.put(0x189, "Crash");
    actionDescriptions.put(0x18A, "Crash");
    actionDescriptions.put(0x18B, "Crash");
    actionDescriptions.put(0x18C, "Crash");
    actionDescriptions.put(0x18D, "Crash");
    actionDescriptions.put(0x18E, "Crash");
    actionDescriptions.put(0x18F, "Crash");
