...
public class OpcodeGroup39 {
  public static Opcode parse(ByteStream bs, byte opcodeByte) throws IOException {
    return switch (opcodeByte) {
      ...
      case 0x01 -> UnknownOpcode.of(0x39, 0x01, 0x14, bs);
      case 0x02 -> UnknownOpcode.of(0x39, 0x02, 0x14, bs);
      case 0x03 -> UnknownOpcode.of(0x39, 0x03, 0x10, bs);
      case 0x04 -> UnknownOpcode.of(0x39, 0x04, 0xc, bs);
      case 0x05 -> UnknownOpcode.of(0x39, 0x05, 0xc, bs);
      case 0x07 -> UnknownOpcode.of(0x39, 0x07, 0xc, bs);
      case 0x08 -> UnknownOpcode.of(0x39, 0x08, 0x24, bs);
      case 0x09 -> UnknownOpcode.of(0x39, 0x09, 0x24, bs);
      case 0x0B -> UnknownOpcode.of(0x39, 0x0B, 0x10, bs);
      ...
      case 0x1d -> UnknownOpcode.of(0x39, 0x1d, 0x10, bs);
      case 0x1e -> UnknownOpcode.of(0x39, 0x1e, 0x10, bs);
