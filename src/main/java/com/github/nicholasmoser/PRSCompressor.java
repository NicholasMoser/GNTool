...
/**
 * A compressor for Eighting PRS compressed files. Takes in the full byte array of the file and returns the uncompressed byte stream.
 * Thanks to Luigi Auriemma for porting to QuickBMS. Thanks to RupertAvery for originally writing it:
 * 
...
public class PRSCompressor
{
    ...
    /**
     * Tests the current buffer position for run length encoding (RLE). This will scan ahead of the current position until the byte
     * changes or the maximum of 256 is reached.
     * 
