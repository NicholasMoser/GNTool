...
/**
 * Reads the filename mappings from the associated resources file. This class can be used to get the filename used for FPK compressed files from the relative path of the file from root after
 * extracted. This is used for the repacking of FPK files.
 */
public class Filenames
{
    ...
    public Filenames()
    {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("filenames.csv"), StandardCharsets.UTF_8)))
        {
            String line;
